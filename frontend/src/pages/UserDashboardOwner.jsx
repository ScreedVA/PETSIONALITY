...
import { optionsOwner } from "../components/Data";
      ...
      {width > 786 ? (
        <div className="flex flex-col justify-between pb-5 text-[#49978B]">
          <div className="flex flex-col flex-1 gap-6 pt-5">
            ...
            <TabMenu selectedIndex={selectedIndex} onIndexChange={setSelectedIndex} options={optionsOwner} />
          </div>
        ...
        <div className="mb-3">
          <TabMenuMobile selectedIndex={selectedIndex} onIndexChange={setSelectedIndex} options={optionsOwner} />
        </div>
      )}
      {/* Main Content */}
